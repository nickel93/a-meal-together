...
const SurveyMatching = () => {
  ...
  return (
    <div className="relative flex flex-col w-full  bg-[#E65F55] text-white  h-screen text-center justify-center overflow-hidden">
      ...
      {progress >= 0 && (
        <div className="absolute top-[5.55%] left-[7.2%]">
          <Icon0 />
        </div>
      )}
      {progress >= 10 && (
        <div className="absolute top-[10.96%] right-[6.52%]">
          <Icon10 />
        </div>
      )}
      {progress >= 30 && (
        <div className="absolute top-[39.4%] left-[21.86%]">
          <Icon30 />
        </div>
      )}
      {progress >= 50 && (
        <div className="absolute bottom-[38.05%] left-[12.8%]">
          <Icon50 />
        </div>
      )}
      {progress >= 70 && (
        <div className="absolute bottom-[13.42%] left-[12.27%]">
          <Icon70 />
        </div>
      )}
      {progress >= 90 && (
        <div className="absolute bottom-[8.62%] right-[11.73%]">
          <Icon90 />
        </div>
      )}
    </div>
